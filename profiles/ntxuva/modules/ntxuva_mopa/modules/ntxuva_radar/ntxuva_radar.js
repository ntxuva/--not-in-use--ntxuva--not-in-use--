...
(function ($) {
  Drupal.behaviors.ntxuvaRadar = {
    ...
    attach: function (context, settings) {
      ...
      $.each(Drupal.settings.geolocation.defaults, function (i, mapDefaults) {
        ...
        // Initial Loading
        Drupal.ntxuvaRadar.addReports(map);
  ...
  Drupal.ntxuvaRadar = {
    ...
    addReports: function (map) {
      ...
      if (map.getZoom() >= Drupal.settings.mopa.ntxuva_radar_zoom) {
        Drupal.ntxuvaRadar.clearMap(map);
        var reportMarkers = Drupal.ntxuvaRadar.geoJsonLoad(currentBounds);
