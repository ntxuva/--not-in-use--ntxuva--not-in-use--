 ...
 */
function mopa_preprocess_html(&$variables) {
 ...
 */
function mopa_preprocess_image(&$variables) {
 ...
 * @see comment.tpl.php
 */
function mopa_preprocess_comment(&$variables) {
 ...
 */
function mopa_form_report_node_form_alter(&$form, &$form_state, $form_id) {
 ...
 */
function mopa_field_widget_geolocation_osm_form_alter(&$element, &$form_state, $context) {
  $element['address']['#description'] = t('Enter an adress.');
}

function mopa_preprocess_node(&$variables) {
