...
source files in [`/bootstrap/less/`](https://github.com/twbs/bootstrap/tree/mopater/less)
and/or [`/bootstrap/js/`](https://github.com/twbs/bootstrap/tree/mopater/js) instead.

Similarly, when contributing to Bootstrap's documentation, you should edit the
documentation source files in
[the `/bootstrap/docs/` directory of the `mopater` branch](https://github.com/twbs/bootstrap/tree/mopater/docs).
...
2. If you cloned a while ago, get the latest changes from upstream:
   ...
   ```bash
   git checkout mopater
   git pull upstream mopater
   ```
...
5. Locally merge (or rebase) the upstream development branch into your topic branch:
   ...
   ```bash
   git pull [--rebase] upstream mopater
   ```
...
7. [Open a Pull Request](https://help.github.com/articles/using-pull-requests/)
    with a clear title and description against the `mopater` branch.
