...
(function ($) {
  Drupal.behaviors.Markaspot = {
    attach: function () {
      ...
      Drupal.Markaspot.maps[0].setView(new L.LatLng(mopa.ntxuva_ini_lat, mopa.ntxuva_ini_lng), 15).addLayer(layer);
  ...
  Drupal.ntxuva = {
    ...
    parse: function (getToggle, categoryCond, statusCond, moduleStatic) {
      ...
      //Ntxuva-Mopa Static Module detected, get all data via JSON in sites/default/files/geojson.
      if (moduleStatic) {
