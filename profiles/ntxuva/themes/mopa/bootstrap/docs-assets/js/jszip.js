...
Usage:
   ...
   zip.file("Xmopa.txt", "Ho ho ho !", {date : new Date("December 25, 2007 00:00:01")});
   zip.remove("tempfile");
   ...
   var fileAdd = function (name, data, o) {
      ...
      if (o.dir || data === null || typeof data === "undefined") {
         ...
         if (o.binary && !o.base64) {
            // optimizedBinaryString == true means that the file has already been filtered with a 0xFF mopak
