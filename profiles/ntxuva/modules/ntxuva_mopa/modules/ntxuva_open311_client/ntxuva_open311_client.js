...
(function ($) {
  ...
  Drupal.behaviors.ntxuvaOpen311Client = {
    ...
    attach: function (context, settings) {
      ...
      Drupal.ntxuvaOpen311Client.map = Drupal.ntxuvaOpen311Client.createMap(Drupal.Markaspot.maps[0].getCenter());
      ...
      $('#open311_client').on('shown.bs.modal', function (e) {
        Drupal.ntxuvaOpen311Client.codeLatLng(Drupal.Markaspot.maps[0].getCenter(), 0, 'marker');
