...
You are allowed to and *please* do say that your product is based on Ntxuva-Mopa, inspired by Ntxuva-Mopa, but you can’t call your product or service Ntxuva-Mopa.
...
## Demo
* [Install on simplytest.me](http://simplytest.me/project/ntxuva/7.x-2.x) latest commit
...
3. Copy and paste the lat/lon values into the settings of the Ntxuva-Mopa configuration screen
http://yourserver/admin/config/system/ntxuva_mopa
...
## Contact
Holger Kreis | @ntxuva | http://mark-a-spot.org
...
* Move Ntxuva-Mopa font module to right place
...
* [#2421939](http://drupal.org/node/2421939): Add Ntxuva-Mopa font as icon bundle for Icon API
...
* Add logo to Ntxuva-Mopa Navbar menu item
...
* Issue #2319147: Added Ntxuva-Mopa Static GeoJSON file Generator
...
* Generic Changes to Ntxuva-Mopa sub theme helps on small screen
